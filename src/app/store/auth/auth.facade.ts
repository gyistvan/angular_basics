...
import { LoginPayload, RegistrationPayload } from 'src/app/auth/services/auth/interfaces/payloads';
...
import { getLoginErrorMessage, getRegistrationErrorMessage, getToken, isUserAuthorized } from './auth.selectors';
...
export class AuthStateFacade {
  ...
  public getRegistrationErrorMessage$ = this.store.pipe(select(getRegistrationErrorMessage));
