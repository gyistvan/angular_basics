...
export const isUserAuthorized = createSelector(selectAuthState, (state: AuthState) => state.isAuthorized);
export const getToken = createSelector(selectAuthState, (state: AuthState) => state.token);
export const getLoginErrorMessage = createSelector(selectAuthState, (state: AuthState) => state.loginErrorMessage);
